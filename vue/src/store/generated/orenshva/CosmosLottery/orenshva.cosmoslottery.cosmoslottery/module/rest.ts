...
export interface CosmoslotteryBetChart {
  accountName?: string;
...
export interface CosmoslotteryQueryAllBetChartResponse {
...
/**
 * @title cosmoslottery/bet_chart.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryBetChartAll
   * @summary Queries a list of BetChart items.
   * @request GET:/orenshva/CosmosLottery/cosmoslottery/bet_chart
   */
  queryBetChartAll = (
    query?: {
    ...
    this.request<CosmoslotteryQueryAllBetChartResponse, RpcStatus>({
      path: `/orenshva/CosmosLottery/cosmoslottery/bet_chart`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryBetChart
   * @summary Queries a BetChart by index.
   * @request GET:/orenshva/CosmosLottery/cosmoslottery/bet_chart/{accountName}
   */
   ...
   * @request GET:/orenshva/CosmosLottery/cosmoslottery/params
   */
